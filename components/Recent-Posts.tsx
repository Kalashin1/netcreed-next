...
const RecentPosts: NextComponentType = () => {
  return (
    <div className="container pt-4 pb-4">
      <div className="row">
        <div className="col-lg-6">
          <div className="card border-0 mb-4 box-shadow h-xl-300">
            <div style={{ backgroundImage: 'url(./assets/img/demo/1.jpg)', height: '150px',    backgroundSize: 'cover', backgroundRepeat: 'no-repeat' }}></div>
