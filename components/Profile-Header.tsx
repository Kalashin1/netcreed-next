...
const uploadPhoto = async (id: string, fileInput: MutableRefObject<HTMLInputElement | null>) => {
...
const ProfileHeader: FC<Props> = ({
  ...
  const profilePhotoForm: MutableRefObject<null | HTMLFormElement> = useRef(null);
  const fileInput: MutableRefObject<null | HTMLInputElement> = useRef(null);

  let theme: string = useContext(ThemeContext).theme;
  return (
    <Card bg={theme} className={`author-box text-${theme === "dark" ? "light" : "dark"}`}>
      <Card.Body>
        <div className="author-box-center"
          ...
          <form ref={profilePhotoForm}>
            <input type="file" ref={fileInput} style={{ display: 'none' }} name="profile-photo" />
          </form>

          <div style={{ position: 'relative', top: '-7rem', right: '-6rem', cursor: 'pointer' }} onClick={e => uploadPhoto(id, fileInput)}>
            <svg xmlns="http://www.w3.org/2000/svg" width="20" fill={`${theme === "dark" ? '#fff' : "#000"}`} viewBox="0 0 576 512"><path d="M402.6 83.2l90.2 90.2c3.8 3.8 3.8 10 0 13.8L274.4 405.6l-92.8 10.3c-12.4 1.4-22.9-9.1-21.5-21.5l10.3-92.8L388.8 83.2c3.8-3.8 10-3.8 13.8 0zm162-22.9l-48.8-48.8c-15.2-15.2-39.9-15.2-55.2 0l-35.4 35.4c-3.8 3.8-3.8 10 0 13.8l90.2 90.2c3.8 3.8 10 3.8 13.8 0l35.4-35.4c15.2-15.3 15.2-40 0-55.2zM384 346.2V448H64V128h229.8c3.2 0 6.2-1.3 8.5-3.5l40-40c7.6-7.6 2.2-20.5-8.5-20.5H48C21.5 64 0 85.5 0 112v352c0 26.5 21.5 48 48 48h352c26.5 0 48-21.5 48-48V306.2c0-10.7-12.9-16-20.5-8.5l-40 40c-2.2 2.3-3.5 5.3-3.5 8.5z" /></svg>
          </div>
        ...
        <div className="text-center">
          ...
          <a href={`https://linkedin.com/in/${linkedin}`} className="btn btn-social-icon mr-1 btn-facebook">
          ...
          <a href={`https://twitter.com/${twitter}`} className="btn btn-social-icon mr-1 btn-twitter">
          ...
          <a href={`https://github.com/${github}`} className="btn btn-social-icon mr-1 btn-github">
          ...
          <a href={`https://red`} className="btn btn-social-icon mr-1 btn-instagram">
            <svg xmlns="http://www.w3.org/2000/svg" width={15} fill={`${theme === "dark" ? '#fff' : "#000"}`} viewBox="0 0 448 512"><path d="M120.12 208.29c-3.88-2.9-7.77-4.35-11.65-4.35H91.03v104.47h17.45c3.88 0 7.77-1.45 11.65-4.35 3.88-2.9 5.82-7.25 5.82-13.06v-69.65c-.01-5.8-1.96-10.16-5.83-13.06zM404.1 32H43.9C19.7 32 .06 51.59 0 75.8v360.4C.06 460.41 19.7 480 43.9 480h360.2c24.21 0 43.84-19.59 43.9-43.8V75.8c-.06-24.21-19.7-43.8-43.9-43.8zM154.2 291.19c0 18.81-11.61 47.31-48.36 47.25h-46.4V172.98h47.38c35.44 0 47.36 28.46 47.37 47.28l.01 70.93zm100.68-88.66H201.6v38.42h32.57v29.57H201.6v38.41h53.29v29.57h-62.18c-11.16.29-20.44-8.53-20.72-19.69V193.7c-.27-11.15 8.56-20.41 19.71-20.69h63.19l-.01 29.52zm103.64 115.29c-13.2 30.75-36.85 24.63-47.44 0l-38.53-144.8h32.57l29.71 113.72 29.57-113.72h32.58l-38.46 144.8z" /></svg>
          </a>
